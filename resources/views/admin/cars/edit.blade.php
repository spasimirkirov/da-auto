<x-app-layout action="/admin/cars/{{ $car->id }}" method="PUT">
    <x-slot:header>
        <h4 class="fs-4 fw-bold">Edit Car - {{ $car->name }}</h4>
        <div class="d-flex justify-content-end gap-2">
            <a class="btn btn btn-outline-secondary" href="/admin/cars">Cancel</a>
    ...
    <div class="container card pt-2 pt-md-4 w-50">
        ...
        <div class="mb-3">
            ...
            {{ html()->input('number', 'mileage', old('mileage', $car->year))->class('form-control')->placeholder('Enter Car Mileage') }}
        </div>
