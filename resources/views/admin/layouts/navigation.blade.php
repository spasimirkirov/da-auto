        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-admin.nav-link :href="route('dashboard')" :active="Request::is('dashboard')">
                        {{ __('Dashboard') }}
                    </x-admin.nav-link>
                    <x-admin.nav-link :href="route('users.index')" :active="Request::is('users/*')">
                        {{ __('Users') }}
                    </x-admin.nav-link>
                    <x-admin.nav-link :href="route('cars.index')" :active="Request::is('cars/*')">
                        {{ __('Cars') }}
                    </x-admin.nav-link>
                    <x-admin.nav-link :href="route('settings.index')" :active="Request::is('settings/*')">
                        {{ __('Settings') }}
                    </x-admin.nav-link>
                </div>
            </div>
